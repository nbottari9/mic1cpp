...
extern void ActivateAlu () ;
extern void ActivateShifter () ;
extern int FirstSubcycle () ; 
extern int SecondSubcycle () ;
extern int ThirdSubcycle () ; 
extern int FourthSubcycle () ;
...
void LoadALatch (DataBusType ABits)
{
int  Register ;
...
void LoadBLatch (DataBusType BBits) 
{
...
void ActivateDataPath (AddressBusType MarRegs, DataBusType MbrRegs, DataBusType ABits, 
			DataBusType BBits, DataBusType CBits, Bit AmuxBit, 
			TwoBits AluBits, TwoBits ShiftBits, Bit MbrBit, Bit MarBit, 
			Bit *NBit, Bit *ZBit)    
{

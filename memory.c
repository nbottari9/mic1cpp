...
extern int  True_ascii_to_mem_ascii();
...
void ActivateMemoryChip0 (ChipRange Offset, DataBusType Data, 
...
void ActivateMemoryChip1 (ChipRange Offset, DataBusType Data,
                        Bit ReadBit, Bit WriteBit)
{
int I ;				/* loop counter index */
...
void ActivateMemoryChip2 (ChipRange Offset, DataBusType Data,
                        Bit ReadBit, Bit WriteBit)
{
int I ;				/* loop counter index */
...
void ActivateMemoryChip3 (ChipRange Offset, DataBusType Data,
                        Bit ReadBit, Bit WriteBit)
{
